...
const products = [
  {
    name: "Book a Stay",
    description: "Get a better understanding of a your traffic",
    href: "#",
    icon: HomeIcon,
  },
  {
        ...
        <div className="flex lg:flex-1">
          <Link href="/" className="m-1.5 p-1.5">
            ...
            <img
              ...
              src="https://images.squarespace-cdn.com/content/v1/5bde0f00c3c16aa95581e2e2/1656116234438-NLIQ8XQTV7D805TPUH8X/booking+logo+white.png?format=2500w"
              alt=""
            />
          </Link>
        </div>
